...
fn main() {
    ...
    // ── AIO callbacks ──
    wire_aio_callbacks(&window, &backend, &shared);
...
fn wire_aio_callbacks(window: &MainWindow, backend: &backend::BackendHandle, shared: &Shared) {
