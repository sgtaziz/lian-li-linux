...
fn render_region(effect: &RgbEffect, scope: RgbScope) -> Result<RegionAnimation> {
    ...
    let (frames, base_ticks) = if effect.disabled || effect.mode == RgbMode::Off {
        ...
        match effect.mode {
            RgbMode::Rainbow => (classic::rainbow(scope, brightness, counter_clockwise), 11),
            ...
            RgbMode::Meteor => (
                paths::meteor(scope, &colors, brightness, counter_clockwise),
                9,
            ),
            RgbMode::ColorCycle => (
                paths_7_12::color_cycle(scope, &colors, brightness, counter_clockwise),
                15,
            ),
            RgbMode::CoverCycle => (
                paths_7_12::cover_cycle(scope, &colors, brightness, counter_clockwise),
                11,
            ),
            RgbMode::Wave => (
                paths_7_12::wave(scope, colors[0], brightness, counter_clockwise),
                16,
            ),
            RgbMode::MeteorShower => (
                paths_7_12::meteor_shower(scope, &colors, brightness, counter_clockwise),
                11,
            ),
            RgbMode::Twinkle => (twinkle::render(&colors, brightness), 11),
            RgbMode::TaiChi => (
                paths_7_12::tai_chi(scope, &palettes, brightness, counter_clockwise),
                11,
            ),
            ...
            RgbMode::MeteorContest => (
                paths_17_22::meteor_contest(scope, &palettes, brightness, counter_clockwise),
                11,
            ),
            RgbMode::ReturnArc => (
                paths_17_22::return_arc(scope, &palettes, brightness, counter_clockwise),
                11,
            ),
            ...
            RgbMode::Disco => (
                paths_17_22::disco(scope, &palettes, brightness, counter_clockwise),
                14,
            ),
